...
fn flatten_numeric_covers_multiplication_with_many_expression_terms() {
    ...
    let expr = NumericExpression::Multiplication(exprion_core::numeric_bucket![
...
fn flatten_numeric_covers_single_and_zero_expression_multiplication_paths() {
    ...
    let single_expr = NumericExpression::Multiplication(exprion_core::numeric_bucket![
    ...
    let zero_expr = NumericExpression::Multiplication(exprion_core::numeric_bucket![
